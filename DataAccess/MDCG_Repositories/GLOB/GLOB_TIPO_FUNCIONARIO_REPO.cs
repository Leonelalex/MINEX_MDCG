...
{
    public class GLOB_TIPO_FUNCIONARIO_REPO : RepositoryBase<GlobTipoFuncionario>, IGLOB_TIPO_FUNCIONARIO_REPO
    {
        private readonly IMDCG_DBContext _DBContext;

        public GLOB_TIPO_FUNCIONARIO_REPO(IMDCG_DBContext dbContext) : base(dbContext)
        {
